...
<body class="bg-light">
    ...
    <div class="sidebar p-3">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li class="nav-item">
                <a href="student_classroom.php" class="nav-link text-white active">
        ...
        <hr class="border-light">
        <a href="../auth/php/logout_admin.php" class="btn btn-outline-light w-100"><i class="bi-arrow-bar-left"></i> Logout</a>
    </div>
        ...
        <div class="row justify-content-center g-2 px-3">
            <div class="col-md-3 mb-4">
                <div class="legend-card p-3 shadow-sm bg-white rounded-3">
                    ...
                    <div class="d-flex align-items-center mb-2"><span class="legend-box occupied me-2"></span>Occupied
                    </div>
